    ...
    <div className="relative">
      <div
        className={cn(
          ...
          active && "ring-2 ring-blue-500/50 shadow-[0_0_15px_rgba(59,130,246,0.25)]"
        )}
      >
        {children}
      </div>
      ...
      >
        <div className="bg-white rounded-lg border border-blue-200 shadow-lg px-3 py-2 flex items-start gap-2 border-l-4 border-l-blue-500">
